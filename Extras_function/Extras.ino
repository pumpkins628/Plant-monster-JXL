...
void loop() {
  ...
  delay(5000);
    readMoisture();
    sendMQTT();
    mySerial.println(GB.dateTime("H:i:s")); // UTC.dateTime("l, d-M-y H:i:s.v T")
...
void readMoisture(){
  ...
  delay(100);
  mySerial.print("Wet ");
  mySerial.println(Moisture);   // read the value from the nails
}
...
void syncDate() {
  ...
  waitForSync();
  mySerial.println("UTC: " + UTC.dateTime());
  GB.setLocation("Europe/London");
  mySerial.println("London time: " + GB.dateTime());
